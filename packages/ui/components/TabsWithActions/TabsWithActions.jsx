...
export function TabsWithActions({
  ...
  const containerClasses = {
    glass: "flex items-center justify-between gap-3 bg-white/70 backdrop-blur-xl border border-white/40 rounded-2xl shadow-xl p-3",
    modern: "flex items-center justify-between gap-3 bg-white border border-gray-200 rounded-xl shadow-lg p-3",
